...
export default function Navbar() {
    ...
    const largeNavbar = (
        <nav className="navbar">
            <ul className="navbar__nav-list">
                <li className="navbar__nav-item">
                    <a href="#home" className="navbar__nav-link">
                        Home
                    </a>
                </li>
                <li className="navbar__nav-item">
                    <a href="#services" className="navbar__nav-link">
                        Servizi
                    </a>
                </li>
                <li className="navbar__nav-item">
                    <a href="#additional-services" className="navbar__nav-link">
                        Servizi Aggiuntivi
                    </a>
                </li>
                <li className="navbar__nav-item">
                    <a href="#estimate" className="navbar__nav-link">
                        Preventivo
                    </a>
                </li>
                <li className="navbar__nav-item">
                    <a href="#where" className="navbar__nav-link">
                        Vieni a Trovarci
                    </a>
                </li>
                <li className="navbar__nav-item">
                ...
                <li className="navbar__nav-item">
                    <a href="#contacts" className="navbar__nav-link">
                        Contattaci
                    </a>
                </li>
                {/* <li className='navbar__nav-item'>
